    ...
    <>
      <section className="z-10 bg-[#E0DBCE]">
        <div className="absolute h-72 w-full">
          <div className="absolute top-0 left-0 h-full w-full rotate-180 bg-[url('/satin/assets/leaf-1.png')] bg-[length:20%_auto] bg-right-top bg-no-repeat" />
        </div>
        ...
        <div className="absolute h-72 w-full">
          <div className="absolute bottom-64 right-0 h-full w-full rotate-180 bg-[url('/satin/assets/leaf-2.png')] bg-[length:20%_auto] bg-left-top bg-no-repeat" />
        </div>
              ...
              <Transition.Child as={Fragment} leave="ease-in duration-200" leaveFrom="opacity-100 scale-100" leaveTo="opacity-0 scale-95">
                <Dialog.Panel className="satin-theme flex h-screen w-full max-w-full transform flex-col items-center justify-center bg-[#E0DBCE] p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="relative z-20">
                    <p className="pt-8 text-center text-lg font-semibold leading-none tracking-[4px] text-satin-100">The Wedding of</p>
                    {/* TODO: Replace-able */}
                    <p
                      data-aos="zoom-in-up"
                      className="satin-secondary pt-4 text-center text-[50px] font-semibold leading-none tracking-[4px] text-satin-900">
